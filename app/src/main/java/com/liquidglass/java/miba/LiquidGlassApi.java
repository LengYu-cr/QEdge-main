...
public final class LiquidGlassApi {
    ...
    /** Caps how often the automatic backdrop is re-recorded (see ActivityBackdropManager#setCaptureThrottle). */
    public static void setAutoBackdropCaptureInterval(View view, long intervalMs) { ActivityBackdropManager.setCaptureThrottle(view, intervalMs); }
